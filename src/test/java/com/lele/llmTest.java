...
public class llmTest {
    ...
    public void testSpringBoot() {
        ...
        String answer = chatLanguageModel.chat("给我介绍一下openclaw");
        System.out.println(answer);
    }
    ...
    public void testGenerationImage() {
        ...
        Response<Image> imageResponse = wanxImageModel.generate("奇幻森林精灵：在一片弥漫着轻柔薄雾的古老森林深处，" +
                ...
                "她有着海藻般的绿色长发，发间点缀着蓝色的小花，皮肤泛着珍珠般的微光。身上穿着由翠绿树叶和白色藤蔓编织而成的连衣裙，" +
                "手中捧着一颗散发着柔和光芒的水晶球，周围环绕着五彩斑斓的蝴蝶，脚下是铺满苔藓的地面，蘑菇和蕨类植物丛生，营造出神秘而梦幻的氛围。");

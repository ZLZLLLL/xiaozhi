...
public class TAGTest {
    ...
    public void testReadDocument() {
        ...
        List<Document> documents = FileSystemDocumentLoader.loadDocuments("D:/test000", pathMatcher, new TextDocumentParser());
    ...
    public void testReadDocumentAndStore() {
        ...
        Document document = FileSystemDocumentLoader.loadDocument("D:/test000/尚硅谷-Java+大模型-硅谷小智（医疗版）.md");
    ...
    @Test
    public void testOpenaiTokenCount() {
        String text = "这是一个示例文本，用于测试 token 长度的计算。";
        UserMessage userMessage = UserMessage.userMessage(text);
        // ✅ 使用 OpenAI tokenizer
